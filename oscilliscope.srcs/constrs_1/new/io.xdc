...
set_property IOSTANDARD LVCMOS33 [get_ports ADC_do]
set_property IOSTANDARD LVCMOS33 [get_ports ADC_di]
set_property IOSTANDARD LVCMOS33 [get_ports ADC_cs]
set_property IOSTANDARD LVCMOS33 [get_ports ADC_clk]
set_property PACKAGE_PIN L3 [get_ports ADC_clk]
set_property PACKAGE_PIN C15 [get_ports ADC_cs]
set_property PACKAGE_PIN K3 [get_ports ADC_di]
set_property PACKAGE_PIN A16 [get_ports ADC_do]
